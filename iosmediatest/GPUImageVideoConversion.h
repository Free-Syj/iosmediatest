...
//Optionally override the YUV to RGB matrices  不需要修改YUV转换的矩阵 就是在这个标准里的。
...
*/
@interface GPUImageVideoConversion : GPUImageOutput // 不需要实现采集 <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
{
